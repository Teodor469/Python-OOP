...
class TestStudent(TestCase):
    ...
    def test_enroll_in_the_same_course(self):
    ...
    def test_enroll_in_new_course_without_third_param(self):
    ...
    def test_enroll_in_new_course_with_third_param(self):
    ...
    def test_enroll_in_new_course_with_no_third_param(self):
    ...
    def test_leave_existing_course_success(self):
